...
HELP = """
<div>въведете ключови думи за търсене с интервал между тях</div>
<div>търсенето е за някоя от въведените думи, ако желаете го ограничите:</div>
<div>-минус пред дума ще търси резултати изключващи я</div>
<div>+плюс пред дума ще търси резултати задължително с нея</div>
<div>за да търсите автори активирайте ключа до текстовото поле</div>
"""